...
const ms = require("ms");
var mutelu = "774985123744972801"; //buraya muteli rolünün id'sini koyunuz
var muteyetkisi = "774985132750274572"; // buraya mute yetkis irolünün id yazınız.
      ...
      if (
        ...
        if (!mutezaman) {
          ...
          let log = msg.guild.channels.find(c =>
            c.name.toLowerCase().includes("chat-mute")
          );
          let vakit = mutezaman
            .replace("m", " dakika")
            .replace("s", " saniye")
...
exports.help = {
  name: "tempmute",                   
  description: "Etiketlediğiniz kişiyi belirli bi süre susturur.",
  usage: ""
};
